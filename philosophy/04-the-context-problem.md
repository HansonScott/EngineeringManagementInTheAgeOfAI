...
Every time I lose that context, whether after a vacation, a long gap between 1:1s, or any significant interruption, I pay a reconstruction tax. I spend the first part of every interaction rebuilding what I already knew before I can get to the actual work.
...
That's when it clicked. Context isn't a prerequisite to doing the work. For managers, context *is* the work. The whole value I provide flows from the context I hold: the coaching, the judgment calls, the well-timed check-in, the accurate read on what's actually going on. Strip that away and what's left is surface-level management.
