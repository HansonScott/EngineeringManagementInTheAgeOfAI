...
A few years ago, my organization told us that using AI was now a baseline expectation for management excellence. Not a suggestion. A baseline.
...
None of that has an obvious AI play. And yet, it's almost entirely information work. And AI is very, very good at information work.

This repo documents what I built and, more importantly, *why*.

---

## The Core Argument

Getting more efficient is easy. The harder question is: efficient toward what?
...
Efficiency without direction is just faster drift.
...
That's what I built. And building it changed how I think about the role.
